      ...
      <div className="relative mx-auto max-w-4xl overflow-hidden rounded-3xl border border-border bg-card p-12 text-center sm:p-20">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <p className="max-w-md text-pretty text-muted-foreground">
            Join the beta and let AI push you beyond your limits.
            It's free. The only cost is your comfort.
          </p>
          <a
            href="https://slaptask.app"
            className="mt-4 inline-flex items-center rounded-xl bg-primary px-10 py-4 font-mono text-sm font-medium tracking-[0.1em] text-primary-foreground uppercase transition-all hover:opacity-90"
          >
            Start Now
          </a>
