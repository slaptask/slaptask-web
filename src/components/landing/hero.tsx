    ...
    >
      ...
      <div className="relative z-10 flex max-w-3xl flex-col items-center text-center">
        ...
        <h1 className="text-balance text-5xl leading-[1.1] font-semibold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
          Хватит планировать.
          <br />
          <span className="text-primary">Начните делать.</span>
        </h1>

        <p className="mt-6 max-w-lg text-pretty text-lg leading-relaxed text-muted-foreground">
          ИИ генерирует ежедневные челленджи, основанные на ваших целях. 
          Никаких оправданий. Никакой жалости. Только выполнение.
        </p>

        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
          <a
            href="#cta"
            className="inline-flex items-center rounded-xl bg-primary px-8 py-4 font-mono text-sm font-medium tracking-widest text-primary-foreground uppercase transition-all hover:opacity-90"
          >
            Попробовать SlapTask
          </a>
          <a
            href="#how-it-works"
            className="inline-flex items-center gap-2 rounded-xl border border-border px-8 py-4 font-mono text-sm font-light tracking-widest text-muted-foreground uppercase transition-colors hover:border-foreground/20 hover:text-foreground"
          >
            Как это работает
          </a>
        </div>
      ...
      <div className="relative z-10 mt-16 w-full max-w-xs sm:mt-20">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card shadow-2xl shadow-primary/5">
          <Image
            ...
            alt="Интерфейс приложения SlapTask с ежедневными задачами"
            width={400}
            height={800}
            className="w-full"
            priority
